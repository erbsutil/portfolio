...
export default defineConfig({
   ...
   * - Vercel: Provides serverless-specific features and analytics when deployed
   */
  integrations: [mdx(), sitemap(), react(), vercel()],
  ...
  env: {
    schema: {
      ...
      SITE_AUTHOR_TITLE: envField.string({ context: 'client', access: 'public', default: 'Frontend Developer' }),
      SITE_AUTHOR_BIO: envField.string({ context: 'client', access: 'public', default: 'Frontend developer with 9 years of experience focused on building performant web applications and maintainable codebases.' }),
